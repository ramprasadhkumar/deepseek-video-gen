...
prompt = "Using Manim v0.19.0, write Python code to visually demonstrate the Pythagorean Theorem on a right triangle with sides 5, 12, 13. Include squares on each side of the triangle to show a² + b² = c², and add explanatory text for each step. Output only the Python code with comments"
...
deepseek_r1_input = f"Question: {prompt}\nAnswer: "
